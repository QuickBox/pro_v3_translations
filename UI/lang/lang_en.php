...
$lang = array_merge(
  $lang,
  require __DIR__ . '/en/navigation.php',
  require __DIR__ . '/en/buttons.php',
  require __DIR__ . '/en/popup.php',
  require __DIR__ . '/en/misc.php',
  require __DIR__ . '/en/widgets.php',
  require __DIR__ . '/en/pages.php',
  require __DIR__ . '/en/settings.php',
  require __DIR__ . '/en/user_management.php',
  require __DIR__ . '/en/system.php',
  require __DIR__ . '/en/help_manual.php',
  require __DIR__ . '/en/dashboard.php',
