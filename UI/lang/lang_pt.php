 ...
 * #3.2.2 - app uninstall
 ************************************/
$L['AIRSONIC_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Airsonic</span> do seu sistema.<br/><br/>Esta acção irá remover completamente todas as suas configurações e definições... esta acção é irreversível.<br/><br/>Pode reinstalar <span style="color:#01cea2">Airsonic</span> em qualquer altura, no entanto, as suas configurações serão reiniciadas para o padrão';
$L['AUTOBRR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Autobrr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e configurações... esta ação é irreversível.<br/><br/>Você pode reinstalar o <span style="color:#01cea2">Autobrr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['AUTODL_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">AutoDL-iRSSi</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">AutoDL-iRSSi</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['AUTOSCAN_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Autoscan</span> do seu sistema.<br/><br/>Esta acção irá remover completamente todas as suas configurações e definições... esta acção é irreversível.<br/><br/>Pode reinstalar <span style="color:#01cea2">Autoscan</span> em qualquer altura, no entanto, as suas configurações serão reiniciadas para o padrão';
$L['BAZARR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Bazarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Bazarr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['BAZARR4K_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Bazarr4K</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Bazarr4K</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['BBR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">BBR</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração do kernel... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">BBR</span> a qualquer momento.';
$L['BTSYNC_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">BitTorrent Sync</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">BitTorrent Sync</span> a qualquer momento, no entanto, as configurações do caminho de armazenamento e da pasta vinculada serão redefinidas para o padrão.';
$L['CALIBRE_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Calibre</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Calibre</span> a qualquer momento, no entanto, suas configurações (Se algumas foram feitas) serão redefinidas para o padrão.';
$L['COUCHPOTATO_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">CouchPotato</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">CouchPotato</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['CSF_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Config Server Firewall (CSF)</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Config Server Firewall (CSF)</span> a qualquer momento, no entanto, suas configurações (se houver alterações) serão redefinidas para o padrão.';
$L['DELUGE_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Deluge</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e pasta compartilhada <strong>todos os usuários</strong>... esta ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Deluge</span> a qualquer momento, no entanto, as configurações do caminho de armazenamento e da pasta vinculada serão redefinidas para o padrão.';
$L['DUPLICATI_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Duplicati</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Duplicati</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['EMBY_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Emby</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Emby</span> a qualquer momento, no entanto, as configurações do caminho de armazenamento e da pasta vinculada serão redefinidas para o padrão.';
$L['FAIL2BAN_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Fail2Ban</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Fail2Ban</span> a qualquer momento, no entanto, as configurações do caminho de armazenamento e da pasta vinculada serão redefinidas para o padrão.';
$L['FILEBOT_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">FileBot</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">FileBot</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['FILEBROWSER_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">File Browser</span> from your system.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">File Browser</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['FLARESOLVERR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Flexget</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Flexget</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['FLEXGET_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Flexget</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Flexget</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['FLOOD_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Flood</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Flood</span> a qualquer momento, no entanto, as configurações do caminho de armazenamento e da pasta vinculada serão redefinidas para o padrão.';
$L['HEADPHONES_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Headphones</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Headphones</span> a qualquer momento, no entanto, as configurações do caminho de armazenamento e da pasta vinculada serão redefinidas para o padrão.';
$L['JACKETT_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Jackett</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Jackett</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['JDOWNLOADER_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">JDownloader</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar o <span style="color:#01cea2">JDownloader</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['JELLYFIN_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Jellyfin</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Jellyfin</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['JELLYSEERR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Jellyseerr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Jellyseerr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['KAVITA_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Kavita</span> do seu sistema.<br/><br/>Esta acção irá remover completamente todas as suas configurações e definições... esta acção é irreversível.<br/><br/>Pode reinstalar <span style="color:#01cea2">Kavita</span> em qualquer altura, no entanto, as suas configurações serão reiniciadas para o padrão';
$L['KOMGA_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Komga</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Komga</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['LAZYLIBRARIAN_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2"> LazyLibrarian </span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas definições de configuração ... essa ação é irreversível.<br/><br/>Você pode reinstalar o <span style="color:#01cea2"> LazyLibrarian </span> a qualquer momento, no entanto, as configurações serão redefinidas para o padrão.';
$L['LETSENCRYPT_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Let\'s Encrypt</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Let\'s Encrypt</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['LIDARR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Lidarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Lidarr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['MEDUSA_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Medusa</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Medusa</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['MYLAR3_UNINSTALL'] = 'Você está prestes a desinstalar o <span style="color:#01cea2"> Mylar3 </span> do seu sistema.<br/><br/>Isso removerá completamente todas as definições de configuração ... essa ação é irreversível.<br/><br/>Você pode reinstalar o <span style="color:#01cea2"> Mylar3 </span> a qualquer momento, no entanto, as configurações serão redefinidas para o padrão.';
$L['NETDATA_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Netdata</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Netdata</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['NEXTCLOUD_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">NextCloud</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">NextCloud</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['NOTIFIARR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Notifiarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Notifiarr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['NOVNC_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">noVNC</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">noVNC</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['NZBGET_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">NZBGet</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">NZBGet</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['NZBHYDRA_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">NZBHydra</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">NZBHydra</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['NZBHYDRA2_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">NZBHydra2</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">NZBHydra2</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['OMBI_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Ombi</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Ombi</span> a qualquer momento, no entanto, as configurações e solicitações da sua biblioteca serão redefinidas.';
$L['OVERSEERR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Overseerr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Overseerr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['OVPN_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">OpenVPN</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">OpenVPN</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['PHPMYADMIN_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">phpMyAdmin</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações do banco de dados de configuração e do phpmyadmin... esta ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">phpMyAdmin</span> a qualquer momento.';
$L['PLEX_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Plex Media Server</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Plex</span> a qualquer momento, no entanto, as configurações da sua biblioteca serão redefinidas para o padrão.';
$L['PROWLARR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Prowlarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Prowlarr</span> a qualquer momento, no entanto, as configurações da sua biblioteca serão redefinidas para o padrão.';
$L['PYLOAD_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">PyLoad</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">PyLoad</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['QBITTORRENT_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">qBittorrent</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e pasta compartilhada <strong>todos os usuários</strong>... essa ação é irreversível.<br/><br/>Você pode reinstalar o <span style="color:#01cea2">qBittorrent</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['QUASSEL_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Quassel</span> do seu sistema.<br/><br/>Isso removerá completamente <span style="color:#01cea2">Quassel</span> e todas as configurações/backlogs armazenados do seu sistema.';
$L['QUOTA_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Quotas</span> do seu sistema.<br/><br/>Isso removerá completamente cotas de usuários e quaisquer configurações associadas a elas.';
$L['RADARR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Radarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Radarr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['RADARR4K_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Radarr4K</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Radarr4K</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['RAPIDLEECH_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Rapidleech</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Rapidleech</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['RCLONE_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">RClone</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">RClone</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['READARR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Readarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Readarr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['REQUESTRR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Requestrr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Requestrr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['RTORRENT_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">rTorrent</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">rTorrent</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['RUTORRENT_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">ruTorrent</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">ruTorrent</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['SABNZBD_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">SABnzbd</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">SABnzbd</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['SEEDCROSS_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">SeedCross</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">SeedCross</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['SICKCHILL_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">SickChill</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">SickChill</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['SICKGEAR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">SickGear</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">SickGear</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['SONARR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Sonarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Sonarr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['SONARR4K_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Sonarr4K</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Sonarr4K</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['SUBSONIC_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Subsonic</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Subsonic</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['SYNCTHING_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Syncthing</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Syncthing</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['TAUTULLI_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Tautulli</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Tautulli</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['THELOUNGE_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">TheLounge</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">TheLounge</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['TRANSMISSION_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Transmission</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Transmission</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['UNIFI_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">UniFi</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">UniFi</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['UNPACKERR_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Unpackerr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Unpackerr</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['WEBCONSOLE_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">Web Console (ttyd)</span> do seu sistema.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Web Console (ttyd)</span> a qualquer momento.';
$L['X2GO_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">x2go</span> do seu sistema.<br/><br/>Isso removerá completamente <span style="color:#01cea2">x2goserver</span> e <span style="color:#01cea2">xfce4</span> ambiente de desktop do seu sistema.';
$L['XTEVE_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">xTeVe</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">xTeVe</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';
$L['ZNC_UNINSTALL'] = 'Você está prestes a desinstalar <span style="color:#01cea2">ZNC</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.<br/><br/>Você pode reinstalar <span style="color:#01cea2">ZNC</span> a qualquer momento, no entanto, suas configurações serão redefinidas para o padrão.';

/* **********************************
 * #3.2.3 - app reinstall
 ************************************/
$L['AIRSONIC_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Airsonic</span> do seu sistema.<br/><br/>Esta acção irá remover completamente todas as suas configurações e definições... esta acção é irreversível.';
$L['AUTOBRR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Autobrr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e configurações... esta ação é irreversível.';
$L['AUTODL_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">AutoDL-iRSSi</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e configurações... essa ação é irreversível.';
$L['AUTOSCAN_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Autoscan</span> do seu sistema.<br/><br/>Esta acção irá remover completamente todas as suas configurações e definições... esta acção é irreversível.';
$L['BAZARR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Bazarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e configurações... essa ação é irreversível.';
$L['BAZARR4K_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Bazarr4K</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e configurações... essa ação é irreversível.';
$L['BBR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">BBR</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração do kernel... essa ação é irreversível.';
$L['BTSYNC_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">BitTorrent Sync</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.';
$L['CALIBRE_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Calibre</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.';
$L['COUCHPOTATO_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">CouchPotato</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['CSF_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Config Server Firewall (CSF)</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['DELUGE_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Deluge</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e pasta compartilhada <strong>todos os usuários</strong>... esta ação é irreversível.';
$L['DUPLICATI_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Duplicati</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['EMBY_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Emby</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.';
$L['FAIL2BAN_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Fail2Ban</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.';
$L['FILEBOT_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">FileBot</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['FILEBROWSER_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">File Browser</span> from your system.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['FLARESOLVERR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Flexget</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['FLEXGET_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Flexget</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['FLOOD_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Flood</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.';
$L['HEADPHONES_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Headphones</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.';
$L['JACKETT_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Jackett</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['JDOWNLOADER_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">JDownloader 2</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações e pastas compartilhadas... essa ação é irreversível.';
$L['JELLYFIN_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Jellyfin</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['JELLYSEERR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Jellyseerr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['KAVITA_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Kavita</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['KOMGA_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Komga</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['LAZYLIBRARIAN_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2"> LazyLibrarian </span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas definições de configuração ... essa ação é irreversível.';
$L['LETSENCRYPT_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Let\'s Encrypt</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['LIDARR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Lidarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['MEDUSA_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Medusa</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['MYLAR3_REINSTALL'] = 'Você está prestes a reinstalar o <span style="color:#01cea2"> Mylar3 </span> do seu sistema.<br/><br/>Isso removerá completamente todas as definições de configuração ... essa ação é irreversível.';
$L['NETDATA_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Netdata</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['NEXTCLOUD_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">NextCloud</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['NOTIFIARR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Notifiarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['NOVNC_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">noVNC</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['NZBGET_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">NZBGet</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['NZBHYDRA_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">NZBHydra</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['NZBHYDRA2_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">NZBHydra2</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['OMBI_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Ombi</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.';
$L['OVERSEERR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Overseerr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['OVPN_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">OpenVPN</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['PHPMYADMIN_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">phpMyAdmin</span> do seu sistema.<br/><br/>Isso removerá completamente todas as configurações do banco de dados de configuração e do phpmyadmin... esta ação é irreversível.';
$L['PLEX_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Plex Media Server</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.';
$L['PROWLARR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Prowlarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.';
$L['PYLOAD_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">PyLoad</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['QBITTORRENT_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">qBittorrent</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações e pasta compartilhada <strong>todos os usuários</strong>... essa ação é irreversível.';
$L['QUASSEL_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Quassel</span> do seu sistema.<br/><br/>Isso removerá completamente <span style="color:#01cea2">Quassel</span> e todas as configurações/backlogs armazenados do seu sistema.';
$L['QUOTA_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Quotas</span> do seu sistema.<br/><br/>Isso removerá completamente cotas de usuários e quaisquer configurações associadas a elas.';
$L['RADARR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Radarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['RADARR4K_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Radarr4K</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['RAPIDLEECH_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Rapidleech</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['RCLONE_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">RClone</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['READARR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Readarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['REQUESTRR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Requestrr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['RTORRENT_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">rTorrent</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['RUTORRENT_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">ruTorrent</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['SABNZBD_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">SABnzbd</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['SEEDCROSS_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">SeedCross</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['SICKCHILL_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">SickChill</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['SICKGEAR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">SickGear</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['SONARR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Sonarr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['SONARR4K_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Sonarr4K</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['SUBSONIC_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Subsonic</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['SYNCTHING_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Syncthing</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['TAUTULLI_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Tautulli</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.';
$L['THELOUNGE_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">TheLounge</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações de configuração e biblioteca... esta ação é irreversível.';
$L['TRANSMISSION_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Transmission</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['UNIFI_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">UniFi</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['UNPACKERR_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Unpackerr</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['WEBCONSOLE_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">Web Console (ttyd)</span> do seu sistema.<br/><br/>Você pode reinstalar <span style="color:#01cea2">Web Console (ttyd)</span> a qualquer momento.';
$L['X2GO_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">x2go</span> do seu sistema.<br/><br/>Isso removerá completamente <span style="color:#01cea2">x2goserver</span> e <span style="color:#01cea2">xfce4</span> ambiente de desktop do seu sistema.';
$L['XTEVE_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">xTeVe</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
$L['ZNC_REINSTALL'] = 'Você está prestes a reinstalar <span style="color:#01cea2">ZNC</span> do seu sistema.<br/><br/>Isso removerá completamente todas as suas configurações... essa ação é irreversível.';
...
$L['ADD_MOUNT_PATH_RCLONE_INFO'] = 'Selecione se esta é uma montagem rclone. Esta opção, quando selecionada, reconhecerá o caminho como uma montagem rclone. Esta opção deve ser marcada se você estiver tentando monitorar uma montagem rclone. Isso garante que os cálculos de espaço sejam precisos.';
...
$L['SEND_WELCOME_EMAIL_YES_INFO'] = 'Definir esta opção como Sim envia emails de boas-vindas ao usuário, bem como ao administrador do sistema. Esta opção requer configuração SMTP para enviar e-mails corretamente. Essas opções podem ser controladas na página <a href="/email-settings.php" style="color: var(--successColor);text-decoration: underline;">Configurações de e-mail</a>.';
...
$L['PATH_HOWTO'] = 'Use ../ para voltar uma pasta';
$L['PATH_INSTRUCTIONS'] = 'O caminho escolhido deve ser definido em relação à pasta administrativa (que será sua raiz do site, definida na página Configurações gerais no painel de controle).
Portanto, você provavelmente desejará voltar a uma pasta antes de escolher qualquer subpasta criada para as páginas exclusivas do usuário. Use <i>../</i> para voltar uma pasta. Então, por exemplo, se o seu site painel de controle do administrador está aqui - <i>http://www.website.com/admin/</i> e suas pastas de usuário estão aqui - <i>http://www.website.com/users/</i> você desejará definir a configuração do caminho para <i>../users/</i> junto com sua página única - assim <i>../users/admin.php</i>. O caminho completo será exibido como <i>http://www.website.com/admin/../users/admin.php</i> - a pasta/arquivo será realmente localizado em <i>http://www.website.com/users/admin.php</i>.</p>';
...
$L['DELETED'] = 'Excluído';
$L['GROUP_DELETED'] = 'Este grupo foi removido, os grupos de usuários foram redefinidos.';
$L['GROUP_STAY'] = 'O grupo ficará :)';
$L['GROUP_YES'] = 'Sim, tenho certeza!';
$L['GROUP_NO'] = 'Não, cancele!';
$L['EDIT_ADD_USER'] = 'Adicionar usuário :';
$L['EDIT_GROUP_LEVEL'] = 'Nível de grupo :';
$L['EDIT_GROUP_NAME'] = 'Nome do grupo :';
$L['GROUP_LEVEL'] = 'Nível de grupo';
$L['GROUP_NAME'] = 'Nome do grupo';
$L['LEVEL_INFO'] = 'Digite um número entre 2 - 256';
$L['NEW_GROUP_NAME'] = 'Novo nome do grupo :';
$L['NUMBER_MEMBERS'] = '# dos membros';
$L['USER_GROUPS_INFO'] = 'Crie, visualize e edite grupos de usuários. Atribuir usuários a grupos de usuários.';
...
$L['API_INFO_DIRECT'] = '<p style="font-weight:600;">Para mais informações e referências sobre a API QuickBox incorporada, <a href="/api-control.php" rel="noopenner nofollow" class="link" style="color:var(--infoColor);">veja esta página</a>.</p>';
...
$L['INFO'] = 'Informações';
$L['ADMIN_BADGE'] = '<span class="badge badge-pills badge-table-menu" style="padding:2px 6px;line-height:0.7rem;background-color:var(--alertLightDangerBorder);color:#fff;font-size:0.5rem;">somente administrador</span>';
...
$L['MULTI_USER_BADGE'] = '<span class="badge badge-pills badge-table-menu" style="padding:2px 6px;line-height:0.7rem;background-color:var(--alertLightInfoBorder);color:#fff;font-size:0.5rem;">multiusuário</span>';
$L['SINGLE_USER_BADGE'] = '<span class="badge badge-pills badge-table-menu" style="padding:2px 6px;line-height:0.7rem;background-color:var(--alertLightPrimaryBorder);color:#fff;font-size:0.5rem;">usuário único</span>';
...
$L['PARTIAL_CONFIG_ONLY_BACKUP'] = 'Backup parcial <span class="badge badge-pills badge-table-menu" style="padding:2px 6px;line-height:0.7rem;background-color:var(--indigo);color:#fff;font-size:0.5rem;">config only</span>';
...
$L['FULL_CONFIG_AND_APP_BACKUP'] = 'Backup completo <span class="badge badge-pills badge-table-menu" style="padding:2px 6px;line-height:0.7rem;background-color:var(--primaryColor);color:#fff;font-size:0.5rem;">config &amp; aplicativo</span>';
...
$L['RESTORE_APP_BACKUP_CONFIG'] = 'Restaurar backup <span class="badge badge-pills badge-table-menu" style="padding:2px 6px;line-height:0.7rem;background-color:var(--indigo);color:#fff;font-size:0.5rem;">config only</span>';
...
$L['RESTORE_APP_DEFAULT_CONFIG'] = 'Restaurar padrão <span class="badge badge-pills badge-table-menu" style="padding:2px 6px;line-height:0.7rem;background-color:var(--indigo);color:#fff;font-size:0.5rem;">config only</span>';
...
$L['LICENSE_TEXT'] = '<p>Copyright (c) 2018-2023, QuickBox.IO. Todos os direitos reservados.</p>
...
$L['HELP'] = 'Help';
//commands
$L['ADDITIONAL_ADMIN_COMMANDS'] = 'Comandos adicionais de configuração de aplicativos do administrador';
$L['ADMIN_UPGRADE_COMMANDS'] = 'Comandos de atualização do administrador';
$L['CLEAN_MEM_INFO'] = 'Use o comando acima como root se/quando você decidir limpar seus sistemas Cache de Memória Física.';
$L['DISKTEST_INFO'] = 'Digite este comando para executar um teste r/w rápido de seu disco.';
$L['ESSENTIAL_USER_COMMANDS'] = 'Comandos Essenciais do Usuário';
$L['FIXHOME_INFO'] = 'Digite este comando para ajustar rapidamente as permissões do diretório /home.';
$L['QUICK_SYSTEM_TIPS'] = 'Dicas Rápidas do Sistema';
$L['QUICKVPN_INFO'] = 'Digite este comando em ssh para configurar seu próprio servidor VPN em não mais que um minuto, bem como gerenciar e criar novos certificados de usuário para usar o servidor VPN.';
$L['SCREEN_IRSSI_INFO'] = 'Permite ao usuário reiniciar/remontar o irssi a partir do SSH.';
$L['SCREEN_RTORRENT_INFO'] = 'Permite ao usuário reiniciar/remontar o rtorrent a partir do SSH.';
$L['UPGRADEBTSYNC_INFO'] = 'Digite este comando em ssh para atualizar o BTSync para a versão mais recente, quando disponível.';
$L['UPGRADEDELUGE_INFO'] = 'Digite este comando em ssh para atualizar o Jackett para a versão mais recente, quando disponível.';
$L['UPGRADEOMBI_INFO'] = 'Digite este comando em ssh para atualizar o Ombi para a versão mais recente, quando disponível.';
$L['UPGRADEPLEX_INFO'] = 'Digite este comando em ssh para atualizar o Plex para a versão mais recente, quando disponível.';
$L['UPGRADERUTORRENT_INFO'] = 'Digite este comando em ssh para atualizar o ruTorrent e o tema club-QuickBox para a versão mais recente, quando disponível.';
/* ************************************************************************************
! END DEPRECATED !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
***************************************************************************************/