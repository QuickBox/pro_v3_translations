...
quickbox::lang::software::wsdashboard::ssl::no_domain() {
  declare text="Nenhum domínio encontrado. A configuração SSL requer um domínio válido."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::certificates_not_found() {
  declare text="Certificados SSL não encontrados nos caminhos esperados."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::access_denied() {
  declare text="Acesso negado aos certificados SSL. Verificar permissões."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::service_failed() {
  declare text="O serviço WSD falhou ao iniciar após a configuração SSL."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::update::no_username() {
  declare text="Nome de usuário é necessário para atualização SSL. Usar parâmetro -u."
  quickbox::dashboard::log "${text}"
}
...
quickbox::lang::software::wsdashboard::ssl::title() {
  declare text="Configuração SSL WSD"
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::header() {
  declare text="Configurando links simbólicos de certificados SSL para o serviço WSD..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::setup::start() {
  declare text="Iniciando configuração de links simbólicos SSL..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::certificates::found() {
  declare text="Certificados SSL encontrados com sucesso."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::creating::symlinks() {
  declare text="Criando links simbólicos para certificados SSL..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::symlinks::created() {
  declare text="Links simbólicos de certificados SSL criados com sucesso."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::testing::access() {
  declare text="Testando acesso aos certificados para usuário www-data..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::certificate::accessible() {
  declare text="Certificado acessível via link simbólico."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::private_key::accessible() {
  declare text="Chave privada acessível via link simbólico."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::env_conf::added() {
  declare text="Configuração SSL adicionada ao env.conf."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::env_conf::exists() {
  declare text="Configuração SSL já existe no env.conf."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::env_conf::updated() {
  declare text="Configuração SSL atualizada no env.conf."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::systemd::override::created() {
  declare text="Override do systemd criado para configuração SSL."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::systemd::override::updated() {
  declare text="Override do systemd atualizado para configuração SSL."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::systemd::reloaded() {
  declare text="Daemon do systemd recarregado com sucesso."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::restarting::service() {
  declare text="Reiniciando serviço WSD..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::service::running() {
  declare text="Serviço WSD executando com sucesso."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::testing::connectivity() {
  declare text="Testando conectividade do serviço..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::https::accessible() {
  declare text="Serviço acessível via HTTPS."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::https::warning() {
  declare text="Serviço não acessível via HTTPS (pode precisar de tempo para iniciar)."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::http::accessible() {
  declare text="Serviço acessível via fallback HTTP."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::http::failed() {
  declare text="Serviço não acessível via HTTP."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::complete() {
  declare text="Configuração de links simbólicos SSL concluída com sucesso!"
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::remove::title() {
  declare text="Remoção SSL WSD"
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::remove::header() {
  declare text="Removendo links simbólicos de certificados SSL para o serviço WSD..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::remove::start() {
  declare text="Iniciando remoção de links simbólicos SSL..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::remove::symlinks::removed() {
  declare text="Diretório de links simbólicos SSL removido com sucesso."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::remove::symlinks::not_found() {
  declare text="Diretório de links simbólicos SSL não encontrado."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::remove::override::removed() {
  declare text="Override do systemd removido com sucesso."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::remove::complete() {
  declare text="Remoção de links simbólicos SSL concluída com sucesso!"
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::update::title() {
  declare text="Atualização SSL WSD"
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::update::header() {
  declare text="Atualizando links simbólicos de certificados SSL para o serviço WSD..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::update::start() {
  declare text="Iniciando atualização de links simbólicos SSL..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::update::symlinks() {
  declare text="Atualizando links simbólicos para certificados SSL..."
  quickbox::dashboard::log "${text}"
}

quickbox::lang::software::wsdashboard::ssl::update::complete() {
  declare text="Atualização de links simbólicos SSL concluída com sucesso!"
  quickbox::dashboard::log "${text}"
}
